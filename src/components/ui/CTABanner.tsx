  ...
  return (
    <section className="py-24 bg-page-bg px-6 md:px-12">
      <motion.div 
        ...
        className="max-w-[1200px] mx-auto bg-surface rounded-[2rem] md:rounded-[3rem] overflow-hidden flex flex-col md:flex-row relative shadow-sm"
      >
        {/* Text Content */}
        <div className="w-full md:w-1/2 p-10 md:p-16 lg:p-20 flex flex-col justify-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif mb-6 leading-[1.1] text-charcoal">
        ...
        {/* Image */}
        <div className="w-full md:w-1/2 p-4 md:p-8 flex items-stretch">
           <div 
             className="w-full h-full min-h-[350px] rounded-[1.5rem] md:rounded-[2rem] bg-cover bg-center"
